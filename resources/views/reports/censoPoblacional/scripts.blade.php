    ...
    var app = new Vue({
        ...
        methods: {
            ...
            downloadExcel(){
                ...
                let paramsCalle = this.selectedCalle != "0" ? "&calle="+this.selectedCalle : "&calle=0"
                ...
                window.location.href="{{ url('api/listado-censo-poblacional/download') }}"+"?"+paramsMunicipio+paramsParroquia+paramsComunidad+paramsCalle
