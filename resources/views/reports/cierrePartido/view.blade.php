                            ...
                            <table class="table table-bordered" border="1" id="tblBody">
                                ...
                                <tbody>
                                    <tr v-for="result in results">
                                        ...
                                        <td>
                                        <button v-if="!municipio_nombre" class="btn btn-info" @click="entity=result;tipo_detalle='municipio';getDetail(result.partido_politico)"  data-toggle="modal" data-target=".marketModal">
                                                Detalle por municipio
                                            </button>
                                            <button v-if="municipio_nombre && !parroquia_nombre" class="btn btn-info" @click="entity=result;tipo_detalle='parroquia';getDetail(result.partido_politico)"  data-toggle="modal" data-target=".marketModal">
                                                Detalle por parroquia
                                            </button>
                                            <button v-if="parroquia_nombre && !centro_votacion_nombre" class="btn btn-info" @click="entity=result;tipo_detalle='centro_votacion';getDetail(result.partido_politico)"  data-toggle="modal" data-target=".marketModal">
                                                Detalle por centro de votación
                                            </button>
                                            <button v-if="centro_votacion_nombre" class="btn btn-info" @click="entity=result;tipo_detalle='mesa';getDetail(result.partido_politico)"  data-toggle="modal" data-target=".marketModal">
                                                Detalle por mesa
                                            </button>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    ...
    var vue_instance = new Vue({
        ...
        methods: {
            async getDetail(partido_politico_nombre){
                this.resultsDetail=[];
                ...
                try {
                    let params={
                        ...
                        partido_politico_nombre:partido_politico_nombre
                    };
                    this.loading = true;
