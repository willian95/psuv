...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-enlace-municipal" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Enlace municipal</h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>Nuevo enlace municipal</button>
                        <!--end::Button-->
                    ...
                    <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="enlace in enlacesMunicipales">
                                        <td>@{{ enlace.municipio.nombre }}</td>
                                        <td>@{{ enlace.personal_caracterizacions?.cedula }}</td>
                                        <td>@{{ enlace.personal_caracterizacions?.nombre_apellido }}</td>
                                        <td>@{{ enlace.personal_caracterizacions?.telefono_principal }}</td>
                                        <td>
                                            <button class="btn btn-success" data-toggle="modal" data-target=".marketModal" @click="edit(enlace)">
                                                <i class="far fa-edit"></i>
                                            </button>
                                            <button class="btn btn-secondary" @click="remove(enlace.id)">
        ...
        @include('clap.enlace_municipal.partials.modalCreateEditForm')
...
@push("scripts")
    @include('clap.enlace_municipal.script')
@endpush
