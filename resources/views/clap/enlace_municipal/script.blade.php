    ...
    methods: {
        ...
        async store(){
            ...
            try{
                ...
                let res = await axios.post("{{ url('api/clap/enlace-municipal') }}", {
                    cedula: this.cedula, 
        ...
        async update(){
            ...
            try{
                ...
                let res = await axios.put("{{ url('api/clap/enlace-municipal') }}"+"/"+this.id, {
                    cedula: this.cedula, 
                    nacionalidad: this.nacionalidad, 
                    nombre_apellido: this.nombre, 
                    sexo: this.sexo, 
        ...
        async fetch(link = "{{ url('api/clap/enlace-municipal/index') }}"){
            ...
            const res = await axios.get(link, {
                params:{
                    "selectedMunicipioEnlaceMunicipal": authUserMunicipio,
            ...
            this.enlacesMunicipales = res.data.data
        ...
        async remove(id){
            ...
            swal({
                title: "¿Estás seguro?",
                text: "Eliminarás este enlace municipal!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then(async (willDelete) => {
                ...
                if (willDelete) {
                    ...
                    let res = await axios.delete("{{ url('api/clap/enlace-municipal') }}"+"/"+id)
        ...
        edit(enlace){
            ...
            this.action = "edit"
            this.modalTitle = "Editar enlace municipal"
            this.id = enlace.id
            this.readonlySelectedMunicipioEnlaceMunicipal = true

            const personalCaracterizacion = enlace.personal_caracterizacions

            this.selectedMunicipioEnlaceMunicipal = enlace.raas_municipio_id
