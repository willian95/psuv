                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="cedula" class="required-field">Cédula Jefe Clap</label>
                                <div class="d-flex">
                                    <div>
                                        <select class="form-control" :disabled="readonlyJefeClap" v-model="jefeClapNacionalidad" style="width: 62px;">
                                            <option value="V">V</option>
                                            <option value="E">E</option>
                                        </select>
                                    </div>
                                    <div>
                                        <input type="tel" :disabled="readonlyJefeClap" class="form-control" id="jefeClapCedula" v-model="jefeClapCedula" maxlength="8" @keypress="isNumber($event)">
                                        <small class="text-danger" v-if="errors.hasOwnProperty('cedula')">@{{ errors['jefeClapId'][0] }}</small>
                                    </div>
                                    <div >
                                        <button class="btn btn-primary" :disabled="readonlyJefeClap" @click="searchJefeClapByCedula()">
