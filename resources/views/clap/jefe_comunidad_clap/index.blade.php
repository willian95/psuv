...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-enlace-municipal" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Jefe comunidad clap</h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>Nuevo jefe comunidad clap</button>
                        <!--end::Button-->
        ...
        @include('clap.jefe_comunidad_clap.partials.modalCreateEditForm')
...
@push("scripts")
    @include('clap.jefe_comunidad_clap.script')
@endpush
