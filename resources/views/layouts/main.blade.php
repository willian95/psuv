						...
						<div id="kt_aside_menu" class="aside-menu my-4 bg-main" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text text-white">Administrativo</span>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('admin/comunidad') }}" class="menu-link">
													...
													<span class="menu-text text-white">Gestionar comunidad</span>
												</a>
											</li>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('admin/calles') }}" class="menu-link">
													...
													<span class="menu-text text-white">Gestionar calles</span>
												</a>
											</li>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('admin/orden-operaciones') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Orden de operaciones</span>
												</a>
											</li>
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<i class="menu-icon flaticon2-group text-white"></i>
										<span class="menu-text text-white">CLAP</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ route('clap.enlace_municipal') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Enlace municipal</span>
												</a>
											</li>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ route('clap.jefe_comunidad_clap') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Jefe comunidad clap</span>
												</a>
											</li>

											<li class="menu-item" aria-haspopup="true">
												<a href="{{ route('clap.jefe_calle_clap') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Jefe calle clap</span>
												</a>
											</li>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<i class="menu-icon flaticon2-group text-white"></i>
										<span class="menu-text text-white">Censo Regional</span>
										<i class="menu-arrow"></i>
									</a>
									<div class="menu-submenu">
										<i class="menu-arrow"></i>
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ route('clap.jefe_familia') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Nucleo Familia</span>
												</a>
											</li>

											<li class="menu-item" aria-haspopup="true">
												<a href="{{ route('clap.lote_calle') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Lote por calle</span>
												</a>
											</li>
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('/listado-jefes') }}" class="menu-link">
													...
													<span class="menu-text text-white">Listado de jefes</span>
												</a>
											</li>

											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('/listado-estructura-clap') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Estructura CLAP</span>
												</a>
											</li>

											<li class="menu-item" aria-haspopup="true">
												<a href="{{ url('/listado-censo-poblacional') }}" class="menu-link">
													<i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
													<span class="menu-text text-white">Censo poblacional</span>
												</a>
											</li>
