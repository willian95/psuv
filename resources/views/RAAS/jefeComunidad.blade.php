...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-jefe-comunidad">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="jefeComunidad in jefesComunidad">
                                        <td>@{{ jefeComunidad.personal_caracterizacion.centro_votacion.nombre }}</td>
...
const app = new Vue({
    ...
    methods: {
        ...
        async searchCedula(){
            ...
            let res = await axios.post("{{ url('api/raas/jefe-comunidad/search-by-cedula') }}", {cedula: this.cedula})
