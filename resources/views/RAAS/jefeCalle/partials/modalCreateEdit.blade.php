                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" maxlength="11" v-if="form.personal_caraterizacion" v-model="form.telefono_principal">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" maxlength="11" v-if="form.personal_caraterizacion" v-model="form.telefono_secundario">
                                <input type="tel" class="form-control" v-else disabled>
                            </div>
                        </div>
