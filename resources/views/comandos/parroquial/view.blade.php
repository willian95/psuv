...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="content" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestión Comando Parroquial</h3>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="result in results">
                                        ...
                                        <td>@{{ result.comision_trabajo.nombre_comision }}</td>
                                        <td>@{{ result.responsabilidad_comando.nombre }}</td>
                                        <td>
        ...
        @include("comandos.parroquial.partials.modalCreateEdit")
...
@push('scripts')
@include('comandos.parroquial.partials.scripts')
@endpush
