    ...
    var vue_instance = new Vue({
        ...
        methods: {
            ...
            async fetch(link = ""){
                ...
                let res = await axios.get(link == "" ? "{{ route('api.comando.parroquial.index') }}" : link.url,{
                    params:filters
                })
            ...
            async store(){
                ...
                try {
                    ...
                    const response = await axios({
                        method: 'POST',
                        responseType: 'json',
                        url: "{{ route('api.comando.parroquial.store') }}",
                        data: this.form
                    });
                    this.loading = false;
                    swal({
            ...
            async edit(entity){
                ...
                //Jefe familia
                this.form.municipio_id=entity.parroquia.municipio_id;
                await this.obtenerParroquias();
                this.form.parroquia_id=entity.parroquia_id;
            ...
            async suspend(entityId){
                ...
                try {
                    ...
                    const response = await axios({
                        method: 'DELETE',
                        responseType: 'json',
                        url: "{{ url('api/comandos/parroquiales') }}"+"/"+entityId,
                        data: {}
                    });
                    this.loading = false;
                    swal({
            ...
            async update(){
              ...
              try {
                    ...
                    const response = await axios({
                        method: 'PUT',
                        responseType: 'json',
                        url: "{{ url('api/comandos/parroquiales') }}"+"/"+this.entityId,
                        params: this.form
                    });
                    this.loading = false;
                    swal({
            ...
            generateExcel(){
                ...
                this.loading=true;
                axios({
                    url: `api/report/comandos/parroquial`,
                    method: 'GET',
                    params:params,
                    ...
                    link.href = url
                    link.setAttribute('download', 'reporte-comandos-parroquiales.xlsx')
