                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="form.municipio_id" :disabled="entityId" @change="obtenerParroquias()">
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="form.parroquia_id" :disabled="entityId"  @change="obtenerCentrosVotacion()">
                                    <option value="" selected>Seleccione</option>
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="form.centro_votacion_id" :disabled="entityId">
                                    <option value="" selected>Seleccione</option>
