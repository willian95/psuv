...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="content" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestión enlace territorial</h3>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="result in results">
                                        <td>@{{ result.centro_votacion.parroquia.municipio.nombre }}</td>
                                        <td>@{{ result.centro_votacion.parroquia.nombre }}</td>
                                        <td>@{{ result.centro_votacion.nombre }}</td>
        ...
        @include("comandos.enlace.partials.modalCreateEdit")
...
@push('scripts')
@include('comandos.enlace.partials.scripts')
@endpush
