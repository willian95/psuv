...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="content" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Listado de personal</h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>Nuevo personal de movimiento</button>
                        <!--end::Button-->
        ...
        @include("movimientos.partials.modalCreateEdit")
        @include("movimientos.partials.modalFamilyCrud")
...
@push('scripts')
@include('movimientos.partials.scripts')
@endpush
