...
$movimientos=\App\Models\Movimiento::query();
if(count($user->movimientos)>0){
    $movimientos->whereIn("id",$user->movimientos->pluck('id')->all());
}
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Movimientos Sociales Listado</h3>
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control" v-model="movimiento_nombre">
                                <option value="">Seleccione</option>
                                @foreach($movimientos as $movimiento)
                                    <option value="{{$movimiento->nombre}}">{{$movimiento->nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                        <!-- End movimientos -->
        ...
        methods: {
            ...
            generate(){
                ...
                let params={
                    ...
                    movimiento_nombre:this.movimiento_nombre,
                    municipio_nombre:this.municipio_nombre,
                    parroquia_nombre:this.parroquia_nombre,
                ...
                axios({
                    ...
                    link.href = url
                    link.setAttribute('download', 'reporte-movimientos-sociales-listado.xlsx')
