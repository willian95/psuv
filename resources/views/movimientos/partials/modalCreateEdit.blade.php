            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Movimiento social</label>
                                <select class="form-control" v-model="form.movimiento_id" v-show="form.personal_caracterizacion" :disabled="entityId">
                                    <option value="" selected>Seleccione</option>
                                    <option v-for="movimiento in movimientos" :value="movimiento.id">@{{movimiento.nombre}}</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="form.area_atencion" v-show="form.personal_caracterizacion" >
                                    <option v-for="area_atencion in areasAtencion" :value="area_atencion">@{{area_atencion}}</option>
                                </select>
                                <select class="form-control" v-show="!form.personal_caracterizacion" disabled>
                                    <option value="" selected>Seleccione</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="form.nivel_estructura_id" v-show="form.personal_caracterizacion">
                                    <option value="" selected>Seleccione</option>
                                    <option v-for="nivel_estructura in nivelesEstructura" :value="nivel_estructura.id">@{{nivel_estructura.nombre_nivel}}</option>
                                </select>
                                <select class="form-control" v-show="!form.personal_caracterizacion" disabled>
                                    <option value="" selected>Seleccione</option>
                                </select>
