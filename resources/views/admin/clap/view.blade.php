...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="content" v-cloak>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestión de claps</h3>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="float-right">
                                        <div class="form-group">
                                            <label>Buscar</label>
                                            <div class="d-flex">
                                                <input class="form-control" placeholder="Por nombre" v-model="searchText">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="result in results">
                                        <td>@{{ result?.comunidades[0]?.parroquia.municipio.nombre }}</td>
                                        <td>@{{ result?.comunidades[0]?.parroquia.nombre }}</td>
                                        <td>@{{ result?.comunidades?.map(data => data.nombre) }}</td>
                                        <td>@{{ result.nombre }}</td>
                                        <td>
        ...
        @include("admin.clap.partials.modalCreateEdit")
...
@push('scripts')
@include('admin.clap.partials.scripts')
@endpush
