...
class EstructuraCLAP implements FromView
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        join public_original.censo_enlace_municipal cem on cem.raas_municipio_id=mu.id
        ...
        join public_original.censo_jefe_clap jclap on jclap.censo_clap_id=clap.id
        join public_original.raas_jefe_comunidad jco on jco.raas_comunidad_id=co.id
