...
class JefeCLAP implements FromView
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        $data = DB::select("SELECT distinct mu.nombre municipio, pa.nombre parroquia, clap.nombre clap, cedula, nombre_apellido, telefono_principal, sugerido
        ...
        where cjc.deleted_at is null ".$this->condition."
         order by municipio, parroquia, clap, cedula;");
