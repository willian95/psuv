...
class CensoPoblacional implements FromView
{
    ...
    */
    ...
    public function view(): View
    {
        ...
        join public_original.raas_parroquia pa on pa.raas_municipio_id=mu.id
        join public_original.raas_comunidad co on co.raas_parroquia_id=pa.id
        join public_original.censo_clap clap on clap.id=co.censo_clap_id
        join public_original.raas_calle on raas_calle.raas_comunidad_id=co.id
        join public_original.raas_jefe_calle jca on jca.raas_calle_id=raas_calle.id
        join public_original.censo_vivienda cviv on cviv.raas_calle_id=raas_calle.id
        join public_original.raas_jefe_familia rjf on rjf.id=cviv.raas_jefe_familia_id
        join public_original.raas_personal_caracterizacion pc on pc.raas_jefe_familia_id=cviv.raas_jefe_familia_id
