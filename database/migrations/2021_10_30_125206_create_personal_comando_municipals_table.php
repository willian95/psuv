...
class CreatePersonalComandoMunicipalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('personal_comando_municipal', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('personal_comando_municipal');
    }
}
